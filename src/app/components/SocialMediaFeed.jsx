...
export function SocialMediaFeed() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      try {
        ...
        // Filtramos para asegurar que tengan foto y tomamos 6 para un grid perfecto (3x2 o 2x3)
  ...
  return (
    // Contenedor principal con brillos de fondo para darle el efecto Premium
    <div className="relative py-10 w-full">
      
      {/* Luces de neón de fondo (se ven sutiles detrás del grid) */}
      ...
      {/* Grid Uniforme (Mismo tamaño para todas las tarjetas) */}
        ...
        {posts.map((post, index) => (
          <AnimatedSection key={post.id} delay={index * 100}>
            ...
            <a
              ...
              // TARJETA: Todos con aspect-[4/5] para ser uniformes, ocultando el desborde para el zoom
            ...
            >
              ...
              {/* 1. Imagen Base (Efecto Parallax Hover) */}
              <img
              ...
              {/* 2. Degradado Base (Para oscurecer la base y que el texto se lea siempre) */}
              <div className="absolute inset-0 bg-gradient-to-t from-gray-900/90 via-gray-900/10 to-transparent opacity-80"></div>

              {/* 3. Degradado de Color Neón (Aparece en Hover) */}
              ...
              {/* 4. Ícono de Facebook (Arriba a la derecha - Glassmorphism) */}
              ...
              {/* 5. Contenedor de Texto e Íconos (Efecto de deslizamiento hacia arriba) */}
              <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 transform translate-y-12 group-hover:translate-y-0 transition-transform duration-700 ease-out flex flex-col justify-end">
                ...
                {/* Íconos sin números (Detalle visual limpio) */}
                ...
                {/* Botón Call to Action Oculto que se revela al hacer Hover */}
